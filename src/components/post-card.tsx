        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs text-fd-muted-foreground inline-flex items-center gap-1">
            ...
            {post.sourceType === 'telegram' ? (
              ...
              >
                <svg viewBox="0 0 24 24" width={12} height={12} fill="currentColor" className="text-fd-muted-foreground transition-colors hover:text-fd-foreground" aria-hidden="true">
